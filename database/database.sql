...
--
-- Host: 127.0.0.1    Database: tienda_test
-- ------------------------------------------------------
...
INSERT INTO `categorias` VALUES (1,'Gatos'),(2,'Perros'),(3,'Hamsteres'),(4,'Peces');
...
INSERT INTO `estados_pedidos` VALUES (1,'Pendiente'),(2,'Entregado');
...
CREATE TABLE `homepage` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_homepage_noticias` (`id_noticia`),
...
INSERT INTO `lineas_pedidos` VALUES (1,1,2,1);
...
CREATE TABLE `localidades` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_provincias_localidades` (`id_provincia`),
  CONSTRAINT `fk_provincias_localidades` FOREIGN KEY (`id_provincia`) REFERENCES `provincias` (`id`)
...
INSERT INTO `pedidos` VALUES (1,7,'jujuy','jujuy capital (?','sarandi 346',90,1,'2020-08-15','19:24:43',NULL,NULL,NULL);
...
CREATE TABLE `productos` (
  ...
  KEY `fk_productos_subcategorias` (`subcategoria_id`),
...
INSERT INTO `productos` VALUES (2,1,'Ratita','Ratita de juguete multicolor con hierba gatera en su interior.',90,11,NULL,NULL,'ratita.jpg',3,NULL,NULL,NULL,NULL,NULL),(3,1,'Gimnasio rascador','Gimnasio para gatos, con juguete y rascador sisal. Colores rosa, violeta, negro y blanco.',1600,6,'','2020-08-09','rascadorGimnasio.jpg',3,'','',0,'',''),(4,2,'Soga trenzada','soga trenzada para perro mediana y resistente. Colores rosa, celeste, verde (moteada). Para perros chicos y medianos.',90,7,NULL,'2020-08-15','Soga trenzada para perros.jpg',1,NULL,NULL,NULL,NULL,NULL),(5,2,'Diario con chifle','Diario con chifle para perros chicos y medianos. 16 cm de ancho. Color hueso.',215.9,7,NULL,'2020-08-15','diario chifle.JPG',1,NULL,NULL,NULL,NULL,NULL),(6,4,'Kit pecera completa','El kit Incuye\r\nPecera de vidrio de 60x35x20\r\n6 placas biologicas\r\n1,5 metros de manguera\r\n1 ventosa\r\n1 piedra difusora\r\n1 pico o cono\r\nGrava para cubrir la base\r\nplanta decorativa\r\nAlimento Tetra pond (la mejor marca del mercado)\r\n1 aireador de 1 salida marca RS\r\n1 aticloro de 80cc',1990,4,NULL,'2020-08-15','pecera kit.JPG',1,NULL,NULL,NULL,NULL,NULL),(7,3,'Bebedero chupete 125 ml','Bebedero para hamsters y roedores en general. Varios colores! de 125 ml y de plástico.',325.9,15,'','2020-08-15','bebedero chupete.JPG',1,'El Molino','perro,proplan,alimento',NULL,'proplan.jpeg',NULL),(8,2,'Pro Plan Adultos','Alimento para perros adultos Purina Pro Plan',4500,20,NULL,'2020-08-25','proplan.jpeg',2,'El Molino','perro,proplan,alimento',NULL,NULL,NULL),(9,2,'Royal Canin Adultos','Alimento para perros adultos Royal Canin',4900,20,'','2020-08-25','royalcanin.jpeg',2,'El Molino 2','perro,proplan,alimento',NULL,'',NULL);
...
INSERT INTO `subcategorias` VALUES (1,'accesorios'),(2,'alimentos'),(3,'juguetes');
...
CREATE TABLE `usuarios` (
  ...
  KEY `fk_usuarios_localidad` (`localidad_id`),
  CONSTRAINT `fk_usuarios_localidad` FOREIGN KEY (`localidad_id`) REFERENCES `localidades` (`id`),
...
-- Dump completed on 2020-09-10 16:18:52
